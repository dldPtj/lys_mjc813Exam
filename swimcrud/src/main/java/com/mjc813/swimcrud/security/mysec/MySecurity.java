package com.mjc813.swimcrud.security.mysec;
...
public class MySecurity {
    private static final String keyString = "Mjc813classThisisMyKey040723";
    private static final String ivString = "QWERasdf1234!";
