...
public class Main {
    ...
    public static void generateAndSendEmail() throws Exception {
        ...
        try {
            ...
            //수신자메일주소
            message.addRecipient(Message.RecipientType.TO, new InternetAddress("coups1234@naver.com"));

            //Subject
            message.setSubject("Leeyeseo Email"); // 메일 제목을 입력

            //Text
            message.setText("abcdefghijklmnopqrstuvwxyz"); // 메일 내용을 입력
